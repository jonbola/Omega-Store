...
export default function ProductDetailPage() {
    ...
    function BottomSection() {
        ...
        const [productQuantityFieldColor, setProductQuantityFieldColor] = useState(blurColor);
            ...
            <View style={{ flexDirection: "row", justifyContent: "center", alignItems: "center" }}>
                <View style={{
                    ...
                    <TextInput
                        ...
                        onFocus={() => setProductQuantityFieldColor(focusedColor)}
                        onBlur={() => setProductQuantityFieldColor(blurColor)} />
                    <TouchableOpacity
                        style={[
                            iconButtonStyle.container15x,
                            { backgroundColor: ThemeColors.babyBlue, borderColor: ThemeColors.blueGreen }
