        ...
        return (
            <View style={{
                ...
                <TouchableOpacity
                    ...
                    onPress={() => {
                        !isAccountValidate(username, password) ?
                            null
                            :
                            !isAdmin(username, password) ?
                                navigation.navigate("CustomerFrame", { isLogged: true })
                                :
                                navigation.navigate("AdminFrame", undefined)
...
function isAccountValidate(accountName: string, password: string): boolean {
...
function isAdmin(accountName: string, password: string): boolean {
    if (accountName != "admin@123" && password != "admin123") {
        return false;
    }
    else {
        return true;
